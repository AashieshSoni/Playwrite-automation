...
<h1>
  Practice api test automation with <a href="https://playwright.dev/"> 
   
  </a> on<a href="https://restful-booker.herokuapp.com/apidoc/index.html#api-Booking">Restful-API-Booker</a>
</h1>

> **Note**
>
> +  **<a href="https://restful-booker.herokuapp.com/apidoc/index.html">Restful-API-Booker</a>** is a public REST API that you can use to learn more about API Testing or try out API testing tools against. 
